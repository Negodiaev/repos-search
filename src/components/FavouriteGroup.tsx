...
export function FavouriteGroup({ owner, favourites }: IFavouriteGroup): JSX.Element {
  return (
    <li className="rounded-xl shadow-xl">
      <div className="flex items-center gap-3 px-4 py-3 min-w-[300px] max-w-[500px] border-b-2 rounded-t-xl text-white bg-gray-600">
        <img
          src={owner.avatar}
          width={AVATAR_SIZE}
          height={AVATAR_SIZE}
      ...
      <ul className="flex flex-col gap-2 list-none p-4 border rounded-b-xl">
